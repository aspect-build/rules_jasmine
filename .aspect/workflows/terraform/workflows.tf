data "google_compute_image" "runner_image" {
  ...
  name    = "aspect-workflows-debian-11-gcc-1-1-0"
}

module "aspect_workflows" {
  # Aspect Workflows terraform module
  source = "https://s3.us-east-2.amazonaws.com/static.aspect.build/aspect/5.8.0-rc1/workflows/terraform-gcp-aspect-workflows.zip"
